...
public class AppConstant {
    ...
    String HQL_BASIC_SEARCH_TERMS = "p.isActive=true AND p.moderationStatus='ACCEPTED' AND p.time<function('NOW')";

    /**
     * <h3>Константы приложения</h3>
     * {@link AppConstant#HQL_BASIC_SEARCH_TERMS Базовое условие поиска}
     */
    private AppConstant() {
    }
