 ...
 * <tr><td>{@link EmailService#sendConfirmEmail}</td><td> - отправка письма для подвержения email</td></tr>
...
public interface EmailService {
    ...
    void sendConfirmEmail(String to, String link) throws InternalServerException;
