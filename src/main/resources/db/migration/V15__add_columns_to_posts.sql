ALTER TABLE `posts` ADD `like_count` bigint(11) NOT NULL DEFAULT 0;
ALTER TABLE `posts` ADD `dislike_count` bigint(11) NOT NULL DEFAULT 0;
ALTER TABLE `posts` ADD `comment_count` bigint(11) NOT NULL DEFAULT 0;
